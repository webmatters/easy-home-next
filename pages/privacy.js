  ...
  return (
    <>
      <main>
        ...
        <h3>Definitions</h3>
        <ul>For the purposes of this Privacy Policy:</ul>
        <li>
          Account means a unique account created for You to access our Service
          or parts of our Service.
        </li>
        Company (referred to as either "the Company", "We", "Us" or "Our" in
        this Agreement) refers to Easy Home. Cookies are small files that are
        ...
        its many uses. Country refers to: North Carolina, United States Device
        ...
        visit). Website refers to Easy Home, accessible from
        http://www.easyhome.so You means the individual accessing or using the
        ...
        Email address Usage Data Usage Data Usage Data is collected
        automatically when using the Service. Usage Data may include information
        ...
        data. We may also collect information that Your browser sends whenever
        ...
        store certain information. Tracking technologies used are beacons, tags,
        and scripts to collect and track information and to improve and analyze
        Our Service. The technologies We use may include: Cookies or Browser
        ...
        Cookies. Flash Cookies. Certain features of our Service may use local
        ...
        browser. Learn more about cookies: Cookies by PrivacyPolicies Generator.
        We use both Session and Persistent Cookies for the purposes set out
        below: Necessary / Essential Cookies Type: Session Cookies Administered
        by: Us Purpose: These Cookies are essential to provide You with services
        ...
        with those services. Cookies Policy / Notice Acceptance Cookies Type:
        Persistent Cookies Administered by: Us Purpose: These Cookies identify
        if users have accepted the use of cookies on the Website. Functionality
        Cookies Type: Persistent Cookies Administered by: Us Purpose: These
        ...
        time You use the Website. For more information about the cookies we use
        and your choices regarding cookies, please visit our Cookies Policy or
        the Cookies section of our Privacy Policy. Use of Your Personal Data The
        Company may use Personal Data for the following purposes: To provide and
        maintain our Service, including to monitor the usage of our Service. To
        manage Your Account: to manage Your registration as a user of the
        ...
        manage Your requests: To attend and manage Your requests to Us. For
        ...
        assets transferred. For other purposes: We may use Your information for
        ...
        situations: With Service Providers: We may share Your personal
        ...
        our legal agreements and policies. The Company will also retain Usage
        Data for internal analysis purposes. Usage Data is generally retained
        ...
        those from Your jurisdiction. Your consent to this Privacy Policy
        ...
        wrongdoing in connection with the Service Protect the personal safety of
        Users of the Service or the public Protect against legal liability
        ...
        may contain links to other websites that are not operated by Us. If You
        ...
        services. Changes to this Privacy Policy We may update Our Privacy
        ...
        posted on this page. Contact Us If you have any questions about this
