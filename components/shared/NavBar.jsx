...
const resources = [
  ...
  {
    name: 'Providers',
    description: 'Interested in working with Easy Home?',
    href: '#',
  },
]
...
export default function Navbar() {
  return (
    <Popover className="relative bg-white">
      <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10 border-b-2 border-gray-100">
